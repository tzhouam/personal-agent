...
# Empty: serve (phase 1), llm (phase 2), admin + onboarding (phase 3) were all
# inverted — every platform module now injects its agent behaviors. Keep it
# empty; a new entry means a regression to fix, not to allowlist.

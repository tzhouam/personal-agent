...
from assistant.agent.website.sections import _about_html, _education_html, _experience_html, _projects_html, _skills_html
from assistant.agent.website.templates import _CSS, _JS
from assistant.agent.website.widgets import _render_calendar, _render_reading, _render_routines

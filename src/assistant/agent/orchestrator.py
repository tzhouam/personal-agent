...
from assistant.agent.collectors import REGISTRY
from assistant.platform.config import Settings
from assistant.agent.deliver.announce import announce_digest
from assistant.agent.deliver.email import render_html, send_email
...
from assistant.agent.state import AssistantState, load_state, persist_state
...
def build_graph(deps: Deps):
    ...
    def node_deliver(state: AssistantState) -> dict:
        ...
        if settings.deployment_mode == "multi_tenant":
            from assistant.platform.jobs import DeliveryLedger

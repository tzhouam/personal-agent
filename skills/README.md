...
|---|---|
| [llm-json-truncation-reasoning-models](llm-json-truncation-reasoning-models/SKILL.md) | Keep stop_reason; repair format once, double truncation budget once, and batch large ID-keyed outputs |
...
| [chinese-ai-media-rss](chinese-ai-media-rss/SKILL.md) | WeChat 公众号 feeds are flaky; fetch concurrently, persist per-source cooldown, and never fail silently |
